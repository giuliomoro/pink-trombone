...
var isFirefox;
var browser;
var audioContextParent;
var FakeDomObject = function(){
	return {
...
if(typeof(window) !== "undefined"){
	...
	tractCanvas = document.getElementById("tractCanvas");
	...
	audioContextParent = window;
} else {
	backCanvas = new FakeDomObject;
	backCtx = null;
	tractCanvas = new FakeDomObject;
	tractCtx = null;
	audioContextParent = {
...
var AudioSystem =
{
    ...
    init : function ()
    {
        audioContextParent.AudioContext = audioContextParent.AudioContext||audioContextParent.webkitAudioContext;
